...
class multigpAPI():
    ...
    def pull_race_data(self, selected_race:str):
        ...
        if returned_json['status']:
            ...
            self._scoringDisabled = returned_json['data']['scoringDisabled']
    ...
    def get_racedescription(self):
        return self._race_description

    def get_scoringformat(self):
        return self._scoringFormat
    
    def get_scoringDisabled(self):
        return self._scoringDisabled
